/*
  ...
  1. Schema Corrections
    - Fix foreign key references and table relationships
    - Add missing columns and constraints
    - Ensure proper data types and defaults

  2. Security Updates
    - Fix RLS policies with correct function references
...
ADD COLUMN IF NOT EXISTS session_type text DEFAULT 'regular' CHECK (session_type IN ('regular', 'trial', 'makeup', 'assessment')),
